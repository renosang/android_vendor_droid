...
#BusyBox
PRODUCT_COPY_FILES += \
    vendor/cm/prebuilt/BusyBox/busybox:/system/xbin/busybox
...
PRODUCT_COPY_FILES += \
    ...
    vendor/cm/prebuilt/common/bin/droid.sh:system/addon.d/droid.sh \
...
PRODUCT_PROPERTY_OVERRIDES += \
  ...
  ro.droid.url=http://droidvn.com \
  ro.droid.name=Droid-OS \
  ro.droid.version=$(PRODUCT_VERSION) \
  ro.dev.team= DroidVn-Team
